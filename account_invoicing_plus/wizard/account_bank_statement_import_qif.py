...
class AccountBankStatementImport(models.TransientModel):
    ...
    qif_encode_type = fields.Selection([('utf-8','UTF-8'), ('latin-1', 'LATIN-1')])
    ...
    def _get_encode(self):
        return self.qif_encode_type
        ...
        if header in [b'Bank', b'Cash', b'CCard']:
            ...
            for line in data_list:
                ...
                if line[:1] == DATE_OF_TRANSACTION:
                    ...
                    vals_line['ref'] = data.decode(self._get_encode())
                elif line[:1] == PAYEE:
                    name = data.decode(self._get_encode())
                    ...
                    vals_line['name'].append(data.decode(self._get_encode()))
